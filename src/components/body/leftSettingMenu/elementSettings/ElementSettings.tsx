        ...
        <div className="displayedtab-module--main-container--B-VV-">
            ...
            <div className="groupedsetting-module--container--2Xetd">
                ...
                <div className="slider-module--slider-container--2O8f7">
                    ...
                    <div className="slider-module--inner--1oNQH">
                        <input type="range" min="-35" max="35" onChange={(e)=>setPosition(e,"x")}
                               step={stepPosition*10} className="slider-module--slider--1oBFm" value={positionValue[0]}/>
                ...
                <div className="slider-module--slider-container--2O8f7">
                    ...
                    <div className="slider-module--inner--1oNQH">
                        <input type="range" min="-35" max="35" step={stepPosition*10} className="slider-module--slider--1oBFm"
                ...
                <div className="slider-module--slider-container--2O8f7">
                    ...
                    <div className="slider-module--inner--1oNQH">
                        <input type="range" min="-35" max="35" step={stepPosition} className="slider-module--slider--1oBFm"
            ...
            <div className="groupedsetting-module--container--2Xetd">
                ...
                <div className="slider-module--slider-container--2O8f7">
                    <span className="slider-module--name--Bwh-H">X</span>
                    <div className="slider-module--inner--1oNQH">
                        <input type="range" min="-5" max="5" step={stepRotation*2}  className="slider-module--slider--1oBFm"
            ...
            <button className="deletebutton-module--button--3QWUO" style={{marginTop: "10px"}} onClick={deleteElement}>Delete Element</button>
        </div>
    );
};
